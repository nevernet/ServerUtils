# alpine 最高支持 3.15， 否则很多 php 依赖包没有
...
```bash
apk add openssl openssl-dev gd gd-dev gettext gettext-dev libxslt libxslt-dev icu icu-dev
apk add libmcrypt libmcrypt-dev readline readline-dev libedit libedit-dev libvpx libvpx-dev
apk add libjpeg-turbo libjpeg-turbo-dev freetype freetype-dev gmp gmp-dev libxml2
apk add libxml2-dev tidyhtml tidyhtml-dev libxpm libxpm-dev
apk add libcrypto1.1 libzip libzip-dev
```

openssl openssl-dev一定要>=1.0.1，<=3， php 8才支持openssl3
