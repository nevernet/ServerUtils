...
# 启动容器
docker run --network br0 --ip 10.0.20.100 -d --privileged=true -h alpine --name alpine alpine:base ash
docker run --network br0 --ip 10.0.20.104 -d --privileged=true -h alpine_java --name alpine_java alpine:base ash

docker run --network br0 --ip 10.0.20.100 -d --privileged=true -h java --name java 10.0.20.200:5000/centos:v2 /bin/bash
