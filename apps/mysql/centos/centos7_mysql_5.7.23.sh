...
tar xvf mysql-5.7.23-1.el7.x86_64.rpm-bundle.tar # 会解压出来很多rpm文件
# 解压出来的文件:
...
# mysql-community-embedded-5.7.23-1.el7.x86_64
# mysql-community-libs-5.7.23-1.el7.x86_64
# mysql-community-devel-5.7.23-1.el7.x86_64
# mysql-community-embedded-devel-5.7.23-1.el7.x86_64
...
# 按顺序删除
 ...
 rpm -e mysql-community-embedded-devel-5.7.23-1.el7.x86_64
 rpm -e mysql-community-devel-5.7.23-1.el7.x86_64
 rpm -e mysql-community-embedded-5.7.23-1.el7.x86_64
 rpm -e mysql-community-libs-compat-5.7.23-1.el7.x86_64
...
rpm -ivh mysql-community-embedded-5.7.23-1.el7.x86_64.rpm
rpm -ivh mysql-community-embedded-devel-5.7.23-1.el7.x86_64.rpm
